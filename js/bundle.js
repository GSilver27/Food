...
function cards() {
    ...
    // тоже, что и выше, но через HTTP-клиент Axios
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-06-26');  // TODO получать текущую дату и прибавлять полгода
